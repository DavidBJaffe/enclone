...
pub struct EncloneVisual {
    ...
    pub archive_snapshot_button_color: Color,
    ...
    pub archive_snapshot_start: Option<Instant>,
    pub sanity_check_start: Option<Instant>,
    pub alluvial_tables_for_spreadsheet: String,
    pub alluvial_tables_for_spreadsheet_cr: String,
    pub alluvial_tables_for_spreadsheet_crd: String,
    pub alluvial_tables_copy_button_color: Color,
    pub alluvial_tables_cr_copy_button_color: Color,
    pub alluvial_tables_crd_copy_button_color: Color,
    pub alluvial_reads_tables_for_spreadsheet: String,
    pub alluvial_reads_tables_for_spreadsheet_cr: String,
    pub alluvial_reads_tables_for_spreadsheet_crd: String,
    pub alluvial_reads_tables_copy_button_color: Color,
    pub alluvial_reads_tables_cr_copy_button_color: Color,
    pub alluvial_reads_tables_crd_copy_button_color: Color,
    ...
    pub summary_snapshot_button: button::State,
    pub archive_snapshot_button: button::State,
    ...
    pub alluvial_tables_cr_copy_button: button::State,
    pub alluvial_tables_crd_copy_button: button::State,
    pub alluvial_reads_tables_copy_button: button::State,
    pub alluvial_reads_tables_cr_copy_button: button::State,
    pub alluvial_reads_tables_crd_copy_button: button::State,
